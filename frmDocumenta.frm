...
Begin VB.Form frmDocumenta 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "frmDocumenta"
   ClientHeight    =   8220
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   15030
   Icon            =   "frmDocumenta.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8220
   ...
   Begin TabDlg.SSTab TabData 
      ...
      TabPicture(0)   =   "frmDocumenta.frx":0884
      ...
      Begin FPSpread.vaSpread SpreadInfoParcoursDV 
         Height          =   5535
         Left            =   -74880
         OleObjectBlob   =   "frmDocumenta.frx":0948
         TabIndex        =   22
         Top             =   600
         Width           =   2220
      End
      Begin FPSpread.vaSpread SpreadInfoParcoursDT 
         Height          =   5535
         Left            =   -74880
         OleObjectBlob   =   "frmDocumenta.frx":0B6F
         TabIndex        =   11
         Top             =   600
         Width           =   2220
      End
      Begin FPSpread.vaSpread SpreadParcours 
         Height          =   2055
         Left            =   60
         OleObjectBlob   =   "frmDocumenta.frx":0D96
         TabIndex        =   7
         Top             =   4320
         Width           =   11205
      End
      Begin FPSpread.vaSpread SpreadRepere 
         Height          =   2295
         Left            =   60
         OleObjectBlob   =   "frmDocumenta.frx":0FBD
         TabIndex        =   6
         Top             =   1440
         Width           =   10605
      End
      Begin FPSpread.vaSpread SpreadTabBrut 
         Height          =   4815
         Left            =   -73080
         OleObjectBlob   =   "frmDocumenta.frx":11E4
         TabIndex        =   34
         Top             =   1800
         Width           =   10570
      End
      Begin FPSpread.vaSpread SpreadTabSS 
         Height          =   4815
         Left            =   -73170
         OleObjectBlob   =   "frmDocumenta.frx":140B
         TabIndex        =   36
         Top             =   1920
         Width           =   10700
      End
      Begin MSChart20Lib.MSChart MSChart1 
         Height          =   5415
         Left            =   -74400
         OleObjectBlob   =   "frmDocumenta.frx":1632
         TabIndex        =   23
         Top             =   500
         Width           =   8000
      End
      ...
      Begin VB.ComboBox ComboRepDebSec 
         Height          =   315
         ItemData        =   "frmDocumenta.frx":3A4C
         Left            =   1360
         List            =   "frmDocumenta.frx":3A4E
   ...
   End
End
Attribute VB_Name = "frmDocumenta"
...
Private Sub Form_Resize()
    ...
    Case Else   ' Autres valeurs.
        MsgBox MsgErreurProg + MsgErreurNumOngletInconnu + MsgIn + "frmDocumenta:Resize", vbCritical
    End Select
...
Private Sub SpreadRepere_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    Else
        ...
        If SpreadRepere.ActiveCol <> 4 Then
            MsgBox MsgErreurProg + MsgErreurNumColInconnu + MsgIn + "frmDocumenta:SpreadRepere_KeyUp", vbCritical
        End If
    End If
End Sub
