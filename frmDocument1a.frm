...
Begin VB.Form frmDocument 
   ...
   Begin TabDlg.SSTab TabData 
      ...
      Tab(1).Control(0)=   "PicBoxDT"
      Tab(1).Control(1)=   "SpreadInfoParcoursDT"
      Tab(1).ControlCount=   2
      TabCaption(2)   =   "Courbe Distance/Vitesse"
      TabPicture(2)   =   "frmDocument.frx":08BC
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "PicBoxDV"
      Tab(2).Control(1)=   "SpreadInfoParcoursDV"
      Tab(2).ControlCount=   2
      TabCaption(3)   =   "Synoptique des Vitesses"
      TabPicture(3)   =   "frmDocument.frx":08D8
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "PicBoxSynoV"
      Tab(3).Control(1)=   "FrameLegende"
      ...
      Tab(5).Control(0)=   "BtnExportTabBrut"
      Tab(5).Control(1)=   "SpreadTabBrut"
      Tab(5).ControlCount=   2
      TabCaption(6)   =   "Synthèse / Statistiques"
      TabPicture(6)   =   "frmDocument.frx":092C
      Tab(6).ControlEnabled=   0   'False
      Tab(6).Control(0)=   "BtnExportTabSS"
      Tab(6).Control(1)=   "SpreadTabSS"
