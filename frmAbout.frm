...
Begin VB.Form frmAbout 
   ...
   Begin VB.Label lblDescription 
      Caption         =   "Recueil et Exploitation de mesures de temps de parcours"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
...
Private Sub Form_Load()
    ...
    HelpContextID = HelpID_WinAPropos
    ...
    monTabString(6) = "    CERTU / Département SYSTEMES / Groupe Transport"
    monTabString(7) = "    CERTU / Département SYSTEMES / Groupe Informatique Technique et Scientifique"
End Sub
...
Private Sub Timer1_Timer()
    ...
    If (ShowIt% Mod 20 = 0) Then
        ...
        Picture1.Print monTabString(monIndMsg% Mod 8)
        ShowIt% = 1
        If monIndMsg% = 8 Then
