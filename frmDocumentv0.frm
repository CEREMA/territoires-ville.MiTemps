...
Begin VB.Form frmDocument 
   ...
   Begin VB.PictureBox PictureItiRef 
      ...
      Begin VB.Image ImageRepere 
         ...
         Index           =   0
         Left            =   150
         Picture         =   "frmDocumentv0.frx":0442
         Stretch         =   -1  'True
   ...
   Begin TabDlg.SSTab TabData 
      ...
      TabPicture(0)   =   "frmDocumentv0.frx":0884
      ...
      Begin FPSpread.vaSpread SpreadTabSS 
         ...
         ScrollBars      =   2
         SpreadDesigner  =   "frmDocumentv0.frx":0948
         UnitType        =   2
         UserResize      =   0
         VisibleCols     =   500
         VisibleRows     =   500
      ...
      Begin FPSpread.vaSpread SpreadTabBrut 
         ...
         ScrollBarExtMode=   -1  'True
         ScrollBars      =   2
         SpreadDesigner  =   "frmDocumentv0.frx":0EFC
         UnitType        =   2
         UserResize      =   0
         VisibleCols     =   500
         VisibleRows     =   500
      ...
      Begin FPSpread.vaSpread SpreadRepere 
         ...
         SpreadDesigner  =   "frmDocumentv0.frx":1349
         UnitType        =   2
         UserResize      =   0
         VisibleCols     =   5
         VisibleRows     =   5
      ...
      Begin FPSpread.vaSpread SpreadParcours 
         ...
         ScrollBarExtMode=   -1  'True
         SelectBlockOptions=   10
         SpreadDesigner  =   "frmDocumentv0.frx":251B
         StartingRowNumber=   0
         UnitType        =   2
         UserResize      =   0
         VisibleCols     =   14
      ...
      Begin FPSpread.vaSpread SpreadInfoParcoursDT 
         ...
         ScrollBars      =   0
         SelectBlockOptions=   10
         SpreadDesigner  =   "frmDocumentv0.frx":35B2
         UnitType        =   2
         UserResize      =   0
         VisibleCols     =   1
         VisibleRows     =   10
      ...
      Begin FPSpread.vaSpread SpreadInfoParcoursDV 
         ...
         ScrollBars      =   0
         SelectBlockOptions=   10
         SpreadDesigner  =   "frmDocumentv0.frx":3D4F
         UnitType        =   2
         UserResize      =   0
         VisibleCols     =   1
         VisibleRows     =   10
      ...
      Begin MSChart20Lib.MSChart MSChart1 
         Height          =   5415
         Left            =   -74400
         OleObjectBlob   =   "frmDocumentv0.frx":44EC
         TabIndex        =   23
         Top             =   500
         Width           =   8000
      End
      ...
      Begin VB.ComboBox ComboRepDebSec 
         Height          =   315
         ItemData        =   "frmDocumentv0.frx":6906
         Left            =   1360
         List            =   "frmDocumentv0.frx":6908
